...
const SMARTPAY_ENDPOINT = "https://payhero-backend-m78g.onrender.com/api/runPrompt";
...
const initiatePay = async () => {
  ...
  try {
     ...
     * TEMPORARY TEST:
     *
     * Do not look for transaction ID.
     * Do not call status endpoint.
     *
     * Wait 2 minutes, then reveal the number.
     */
